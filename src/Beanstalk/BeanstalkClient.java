...
public class BeanstalkClient {
	...
	// Dirección donde se encuentra el beanstalk
	protected String addr;
	
	// Puerto de conexión
	protected int port;
	
	// Canal por el que se comunica y envía el cliente los mensajes
	...
	/*
	 * Constructor Dirección y Puerto
	 * */
	...
	/*
	 * Constructor dirección, puerto y tubo al que enviará los
	 * mensajes
	 * */
	...
	/*
	 * Constructor indicando además de la dirección, el puerto y el canal;
	 * la piscina de mensajes que utilizará. 
	 * */
	...
	/*
	 * Método init que se realiza al crear el proceso y que se encarga de 
	...
	private void init() throws BeanstalkException{
		...
		try {
			...
			if (this.tube != null) {
				//System.out.println("Voy a poner el uso del tube: "+tube);
				this.useTube(tube);
				this.watchTube(tube);
	...
	/*
	 * Tubería que utilizará el determinado cliente para comunicarse con 
	 * el resto
	 * 
	 * */
	public void useTube(String tube) throws BeanstalkException{
		try {			
			...
			//System.out.println("Voy a hacer uso del tubo" +tube);
			String line = con.readControlResponse();
			this.tube = tube;
			//System.out.println("He conseguido respuesta" +tube+"    "+line);
			log.debug(line);
	...
	/*
	 * Observa la tubería. Indica que observe una serie de tubos que será de los que reciba 
	 * */
	public void watchTube(String tube) throws BeanstalkException{
		try {			
			this.init();
			con.write("watch " + tube + "\r\n");
			//System.out.println("Vengo a leer la response ");
			//System.out.println("Es por watchtube");
	...
	/*
	 * Indica a qué canales no va a hacer caso
	 * */
	...
	*/ 
	...
	/*
	 * Indica el estado del canal que consultamos en concreto
	 * */
...
//			String line = in.readLine();
			//System.out.println("Es por useTube");
...
//			log.info("READ RESPONSE IN : " + (new Date().getTime() - start.getTime()) );
	...
	/*
	 * Una vez se ha acabado el trabajo una de las opciones es borrarlo
	 * */
	...
	public void deleteJob(long id) throws BeanstalkException {
		try {			
			...
			log.debug(command);
			con.write(command);
			//System.out.println("Es por deleteJOB");
	...
	public BeanstalkJob reserve(Integer timeoutSeconds) throws BeanstalkException{
		try {			
			...
			//System.out.println("Es por reserve");
...
//			log.info("GOT TASK: " + new String(bytes));
	...
	/*
	 * Pone uno de los trabajos de nuevo en la cola
	 * */
	...
	/*
	 * Métodos Getters y Setters para obtener los valores que no muestra
	 * 
	 * */
	public BeanstalkConnection getConnection(){
		return this.con;
	}
